...
| [docs/deploy.md](docs/deploy.md) | deploying / changing infra, Vercel + Railway (web ×2 + worker cron + Redis) + Supabase, env var inventory, CI + staging→prod promote, Dockerfile/`railway.toml`, prelaunch checklist |
