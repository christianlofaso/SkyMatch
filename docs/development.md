...
3. Add to `ProfileAnalysisSchema` in `frontend/src/types/skymatch.ts`
...
4. Update frontend Zod schema in `skymatch.ts`
...
3. Update `InternshipBucketsSchema` in `skymatch.ts`
